...
$owners = $conn->query("
    SELECT u.id, u.name, MAX(m.created_at) AS last_msg
    FROM users u
...
if ($chat_with) {
    $q = $conn->prepare("
      ...
      WHERE 
        (m.sender_id = ? AND m.receiver_id IN (SELECT id FROM users WHERE role='shelter'))
        OR
        (m.sender_id IN (SELECT id FROM users WHERE role='shelter') AND m.receiver_id = ?)
      ORDER BY m.created_at ASC
    ");
    $q->bind_param("ii", $chat_with, $chat_with);
    $q->execute();
  ...
  <div class="page container-fluid">
    <aside class="sidebar">
      <div class="links mb-3">
        ...
        <a href="add_pet.php" class="btn btn-sm btn-primary mt-2 w-100">+ Add Pet</a>
      </div>
          ...
          <div class="chat-box">
            <div class="chat-messages">
              <?php while ($m = $chat_msgs->fetch_assoc()): 
                $isShelter = ($m['sender_role'] === 'shelter');
      ...
      <?php else: ?>
        ...
        <section id="pets" class="card-glass">
          <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <a href="add_pet.php" class="btn btn-sm btn-primary">+ Add Pet</a>
          </div>
          <div class="row">
              ...
              <div class="col-md-6 col-lg-4 mb-3">
                <div class="pet-card">
                  ...
                  <div style="flex:1">
                    ...
                    <div class="mt-2">
                      <a href="edit_pet.php?id=<?php echo intval($p['pet_id']); ?>" class="btn btn-sm btn-warning">Edit</a>
                      <a href="delete_pet.php?id=<?php echo intval($p['pet_id']); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this pet?')">Delete</a>
